...
const titlestyle = {"padding-center" : "5px", "font-weight" : "bold"};
        ...
        return(
            <div className='fullheight'>
                <div className='header'>
                    <label style={titlestyle}>Online Voting System</label>
                ...
                <div className='footer'>Copyright @ Election Commission . All rights reserved.</div>
            </div>
        );
    }
}
