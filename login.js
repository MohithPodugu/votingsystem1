...
function Login(){
    ...
    return(
        <div className='fullheight'>
            <div id='loginheader' className='loginheader'>Online Voting System</div>
            <div id='logincontent'>
                ...
                <div id="registration" className='popup'>
                    <div id='registrationwindow' className='popupwindow' style={popupwindowstyle}>
                        ...
                        <div id='reginnerwindow' className='innerwindow'>
                            ...
                            <div style={space}></div>
                            <div>Epic no*</div>
                            <div> <input type='text' id='RT6' className='textbox' autoComplete='off' /> </div>
                            <div style={space}></div>
                            <div>Father*</div>
                            <div> <input type='text' id='RT7' className='textbox' autoComplete='off' /> </div>
                            <div style={space}></div>
            ...
            <div id='loginfooter'>Copyright @ Election Commission. All rights reserved.</div>
        </div>
    );
}
